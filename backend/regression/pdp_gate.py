...
from backend.pdp.schemas import PolicyRequest


def _load_policy_engine():
    spec = importlib.util.find_spec("backend.pdp.policy_engine")
    if spec is None:
        return None
    module = importlib.import_module("backend.pdp.policy_engine")
