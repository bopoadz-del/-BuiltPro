...
from backend.pdp.schemas import (
    PolicyRequest,
    PolicyDecision,
    Policy,
    PolicyType,
...
from backend.pdp.policy_engine import PolicyEngine
from backend.pdp.acl_manager import ACLManager
from backend.pdp.rate_limiter import RateLimiter
from backend.pdp.content_scanner import ContentScanner
from backend.pdp.audit_logger import AuditLogger
from backend.pdp import models as pdp_models
...
def check_rate_limit(
    ...
    try:
        ...
        from backend.pdp.rate_limiter import RATE_LIMITS
