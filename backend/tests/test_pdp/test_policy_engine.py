...
from backend.pdp.schemas import PolicyRequest, PolicyType, Role
from backend.pdp.models import Policy, AccessControlList
from backend.models import Base, User, Project
...
def test_log_decision_audit_trail(db_session):
    ...
    from backend.pdp.models import PDPAuditLog as AuditLog
